...
import A8_AOPXml.service.IUserService;
 ...
 *  > Target:目标对象
 *  > Proxy :代理对象
 *  > Aspect:切面，"切入点" + "通知(通知类型+通知方法)"
 *  > JoinPoint连接点：需要被增强的类中所有方法
 *  > PointCut切入点 ：定位连接点的方式，对哪些连接点进行拦截的定义
 *  > Advice通知：拦截到切入点后执行的事情(切面内容)
 *      > 通知类型 + 通知方法
...
public class AOPXml {
    public static void main(String[] args) {
        ApplicationContext ctx = new ClassPathXmlApplicationContext("A8_AOPXml/Spring-AOP.xml");
